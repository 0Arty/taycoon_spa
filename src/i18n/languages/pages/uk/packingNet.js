export const packingNet = {
    ...
    tree : {
        "heading" : "Сітка рукав для упакування дров",
        "text1" : "Забезпечує надійну фіксацію та зручну доставку дров",
        "text2" : "Додаткова міцність і стійкість до впливу навколишнього середовища роблять сітку екструдовану оптимальним вибором для пакування та зберігання дров",
    },
    cards:{
        "heading" : "Переваги",
        "card1 head" : "Міцність",
