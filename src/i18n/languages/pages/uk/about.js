export const about = {
    ...
    info:{
        "guarantees":"Підприємство Taycoon на ринку вже більше 25-ти років, тому ми знаємо, що таке якість та надійність.  Наше виробництво відповідає стандартам ISO 9001:2015 та успішно пройшло ресертифікацію 2023 року.",
        "factory":"Спеціалізуємось на виробництві високоякісних добавкок, композитів, суперконцентратів (будь-яких кольорів) призначених для виробництва полімерних виробів. Також виготовляємо екструдовану сітку-рукав, для будь-яких потреб",
        "advantage":"Головна наша перевага – це індивідуальний підхід до клієнта. Ми готові надати консультацію, та виготовити, необхідну сітку чи добавку, яка буде спеціалізована для Ваших потреб. Ваше замовлення буде супроводжуватись нашим технологом",
        "lab":"Маємо власну лаболаторію для синтезу кольорів та контролю якості, згідно замовлення клієнта. Після оформлення замовлення, у короткий термін, буде розроблена рецептура, надані зразки згідно ваших вимог ",
    ...
    eco:{
        ...
        "p6":" Підприємство визнає свою відповідальність за власні дії і їхній вплив на довкілля.",
