export const about = {
    ...
    info:{
        ...
        "factory":"Спеціалізуємось на виробництві високоякісних добавок, композитів, суперконцентратів призначених для виробництва полімерних виробів. Також виготовляємо екструдовану сітку-рукав, для будь-яких потреб",
        "advantage":"Наша ключова перевага - індивідуальний підхід до кожного клієнта. Консультанти готові надати професійну консультацію та виготовити спеціалізовану сітку чи добавку, яка відповідає замовленню . Процес розробки та виготовлення буде супроводжуватись нашим технологічним експертом",
