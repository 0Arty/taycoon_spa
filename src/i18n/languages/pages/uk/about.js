export const about = {
    ...
    info:{
        ...
        "factory":"Спеціалізуємось на виробництві високоякісних добавок, композитів, суперконцентратів (будь-яких кольорів) призначених для виробництва полімерних виробів. Також виготовляємо екструдовану сітку-рукав, для будь-яких потреб",
