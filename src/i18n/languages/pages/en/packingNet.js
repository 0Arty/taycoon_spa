export const packingNetEN = {
    ...
    vegatbles: {
        "heading" : "Mesh sleeve for packing fruit and vegetables",
        ...
        "text3" : "The mesh can be used for both manual and automatic packaging",
    },
    crimping: {
        "heading" : "Sleeve mesh for corrugating sausage casings",
        characteristics:{
        ...
        "text2" : "The width of the meshes corresponds to the calibre of the shell manufacturers",
    },
    toys: {
        "heading" : "Mesh sleeve for packing toys",
    ...
    glass: {
        "heading" : "Protective mesh sleeve for glass containers, bottles, furniture and metal products",
    ...
    cards:{
        ...
        "card1 title" : "made of high quality polyethylene, which allows you to create a strong and resistant mesh to loads",
